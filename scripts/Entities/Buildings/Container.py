...
TEXTURE = load_texture("assets/entities/small_container.png", TEXTURE_SIZE)
...
class Container(Building, metaclass=EntityRegistry):

    def __init__(self, code, pos, parent):

        super().__init__(code, pos, parent, TEXTURE, 100, TEXTURE_OFFSET, "container", "axe", 16, SOUND, ui_id="ContainerUI",
                         collider_hitbox_size=HITBOX_SIZE, collider_hitbox_offset=HITBOX_OFFSET)
        self.inventory = Inventory(self, 30)
