...
TEXTURE = load_texture("assets/entities/iron_chest.png", TEXTURE_SIZE)
...
class IronChest(Building, metaclass=EntityRegistry):

    def __init__(self, code, pos, parent):

        super().__init__(code, pos, parent, TEXTURE, 100, TEXTURE_OFFSET, "iron_chest", "pickaxe", 3, SOUND, ui_id="IronChestUI",
...
#                 SOUND.play()
#                 if self.hp <= 0:
#                     self.parent.drop_items(self.pos, "iron_chest", 1)
#                     for item, amount in zip(self.inventory.n, self.inventory.a):
#                         self.parent.drop_items(self.pos, item, amount)
