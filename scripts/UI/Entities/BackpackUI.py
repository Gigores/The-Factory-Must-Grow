...
class BackpackUI(BaseUI, metaclass=UIRegistry):
    ...
    def __init__(self, parent):
        ...
        self.main_ui_pos = RESOLUTION / Vector(2, 2) - Vector(BLANK.get_width()*2, BLANK.get_height()) / Vector(2, 2)
        self.main_ui_texture = pg.transform.scale(BLANK, (BLANK.get_width()*2, BLANK.get_height()))
        ...
        self.bg.blit(FONT.render("Backpack", True, "#757575"), (self.main_ui_pos.x + 40, self.main_ui_pos.y + 20))
    ...
    def update(self, obj: any):
        ...
        self.inventory = self.parent.backpack
    ...
    def __get_main_ui_button_pos(self, n: int):
        ...
        return self.main_ui_pos.x + 36 + (FRAME_SIZE[0] + FRAME_SIZE[0] / 16) * (n % 10), self.main_ui_pos.y + 90 + (FRAME_SIZE[1] + FRAME_SIZE[0] / 16) * (n // 10)
