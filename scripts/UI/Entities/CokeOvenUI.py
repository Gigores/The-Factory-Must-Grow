...
from scripts.Entities.Buildings.CokeOven import CokeOven
...
class CokeOvenUI(BaseUI, metaclass=UIRegistry):
    ...
    def __init__(self, parent):
        ...
        self.bg.blit(FONT.render("Coke Oven", True, "#757575"),
