...
from scripts.Entities.Buildings.Container import Container
...
class ContainerUI(BaseUI, metaclass=UIRegistry):
    ...
    def __init__(self, parent):
        ...
        self.main_ui_size = from_iterable(BLANK.get_size()) * Vector(2, 1.2)
        ...
        self.bg.blit(FONT.render("Container", True, "#757575"), (self.main_ui_pos.x + 20, self.main_ui_pos.y + 20))
    ...
    def __get_main_ui_button_pos(self, n: int):
        ...
        return self.main_ui_pos.x + 18 + (FRAME_SIZE[0] + FRAME_SIZE[0] / 16) * (n % 10), self.main_ui_pos.y + 90 + (
