...
class IronChestUI(BaseUI, metaclass=UIRegistry):
    ...
    def __init__(self, parent):
        ...
        self.main_ui_texture = pg.transform.scale(BLANK, (BLANK.get_width(), BLANK.get_height() * 1.5))
        ...
        self.bg.blit(FONT.render("Iron Chest", True, "#757575"), (self.main_ui_pos.x + 20, self.main_ui_pos.y + 20))
    ...
    def __get_main_ui_button_pos(self, n: int):
        ...
        return self.main_ui_pos.x + 18 + (FRAME_SIZE[0] + FRAME_SIZE[0] / 16) * (n % 5), self.main_ui_pos.y + 90 + (
                    FRAME_SIZE[1] + FRAME_SIZE[0] / 16) * (n // 5)
