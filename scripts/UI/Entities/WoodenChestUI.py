...
class WoodenChestUI(BaseUI, metaclass=UIRegistry):
    ...
    def __init__(self, parent):
        ...
        self.bg.blit(FONT.render("Wooden Chest", True, "#757575"), (self.main_ui_pos.x + 20, self.main_ui_pos.y + 20))
    ...
    def update(self, obj: WoodenChest):
    ...
    def __get_main_ui_button_pos(self, n: int):
        ...
        return self.main_ui_pos.x + 18 + (FRAME_SIZE[0] + FRAME_SIZE[0] / 16) * (n % 5), self.main_ui_pos.y + 90 + (FRAME_SIZE[1] + FRAME_SIZE[0] / 16) * (n // 5)
